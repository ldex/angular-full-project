...
export class ProductUpdateComponent  implements OnInit {
  ...
  createForm() {
    let validImgUrlRegex: RegExp = new RegExp('^(https?://[a-zA-Z0-9-.]+.[a-zA-Z]{2,5}(?:/S*)?(?:[-A-Za-z0-9+&@#/%?=~_|!:,.;])+.)(\\?(?:&?[^=&]*=[^=&]*)*)?$')
    ...
    this.description = new FormControl(this.product.description, [Validators.minLength(3), Validators.maxLength(500)])
